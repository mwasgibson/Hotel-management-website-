...
const { createBooking, rescheduleBooking, getBookings, getBooking, cancelBooking, completeBooking, reserveRoom, getMyCurrentBooking, getCurrentBookings } = require('../controllers/bookingControllers');
const { createWalkInBooking } = require('../controllers/walkInControllers');
const allowedRoles = require('../middleware/allowedRoles');

router.post('/', authMiddleware, createBooking);
router.post('/walk-in', authMiddleware, allowedRoles(['receptionist']), createWalkInBooking);
router.get('/', authMiddleware, getBookings);
router.get('/current', authMiddleware, allowedRoles(["receptionist"]), getCurrentBookings);
